...
//     const updated = [...courseCurriculumFormData];
//     updated[index].freePreview = value;
//     setCourseCurriculumFormData(updated);
//   }

//   function handleYouTubeLinkChange(e, index) {
//     const updated = [...courseCurriculumFormData];
...
//             </div>
//             <div className="mt-4">
//               <Label htmlFor={`youtube-${index + 1}`}>YouTube Link</Label>
//               <Input
//                 type="url"
...
//               {lecture.videoUrl && (
//                 <div className="mt-2">
//                   <VideoPlayer url={lecture.videoUrl} width="450px" height="200px" />
//                 </div>
//               )}
//               <Button
//                 onClick={() => handleDeleteLecture(index)}
